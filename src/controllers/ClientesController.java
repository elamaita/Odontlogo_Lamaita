    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == views.btn_añadir_cliente) {
            if (views.txt_apellido_cliente.getText().equals("")
                ...
                cliente.setDocumento(Integer.parseInt(views.txt_documento_cliente.getText()));
                cliente.setNombre(views.txt_nombre_cliente.getText());
                cliente.setApellido(views.txt_apellido_cliente.getText());
                cliente.setDireccion(views.txt_direccion_cliente.getText());
                cliente.setTelefono(views.txt_telefono_cliente.getText());
                cliente.setEmail(views.txt_email_cliente.getText());
                cliente.setFecha_nacimiento(ff.format(views.date_cliente.getCalendar().getTime()));
            ...
            if (views.txt_eliminar_cliente_documento.getText().equals("")
                ...
                cliente.setDocumento(Integer.parseInt(views.txt_eliminar_cliente_documento.getText()));
