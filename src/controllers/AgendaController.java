    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == view.btn_añadir_paciente) {
            if (view.txt_apellido_paciente.getText().equals("")
                ...
                agenda.setDocumento(Integer.parseInt(view.txt_documento_paciente.getText()));
                agenda.setNombre(view.txt_nombre_paciente.getText());
                agenda.setApellido(view.txt_apellido_paciente.getText());
            ...
            if (view.txt_consulta_cancelar_documento.getText().equals("")
                ...
                agenda.setDocumento(Integer.parseInt(view.txt_consulta_cancelar_documento.getText()));
